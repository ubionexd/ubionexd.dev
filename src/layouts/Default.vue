    ...
    <header class="top-0 left-0 z-40 w-full">
      ...
      >
        <h1 style="font-family: 'JetBrains Mono', monospace">
          <a class="decoration-none" href="/">ubionexd</a> > {{ pageName }}
        </h1>
        ...
        >
          ...
          <div class="item">
            <a class="light:text-[#363636] dark:text-[#e2e2e2]">
              <li class="comingsoon hover:text-gray-600">
                <span class="align">Projects</span>
              </li>
            </a>
          </div>
